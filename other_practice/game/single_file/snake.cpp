...
int main()
{
    ...
    do
    {
        ...
        {
            std::cout << "Welcome to the retro C++ Snake Game" << std::endl
                      << std::endl;
            std::this_thread::sleep_for(std::chrono::milliseconds(1500));
            std::cout << "For best results make your Terminal FULL SCREEN!" << std::endl
                      << std::endl;
        ...
        // play again?
        std::cout << std::endl
                  << "Current High Score: " << high_score << std::endl;
        ;
    ...
    std::cout << std::endl
              << "Thanks for playing the C++ Snake Game!" << std::endl;
